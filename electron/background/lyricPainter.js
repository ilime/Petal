...
export const lyricWidth = 150, lyricHeight = 22
const fontSize = 14, minWaitTime = 3000, scrollFPS = 25, lyricTextPadding = 8
...
export class Lyric extends Canvas {
  ...
  nextLyric(text, duration) {
    ...
    this.lyricWaitTimer = setTimeout(() => {
      const overflowWidth = fullWidth - this.canvas.width + 2 * lyricTextPadding, scrollFrame = ((duration - waitTime) * scrollFPS) / 1000, scrollDisPerFrame = overflowWidth / scrollFrame
