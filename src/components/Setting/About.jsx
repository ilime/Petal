    ...
    return (
      <div className="petal-setting-about">
        ...
        <div className="content">
          <p><span onClick={openInDefaultBrowser('https://github.com/ilime/Petal')}>Petal</span>是一个豆瓣FM第三方客户端。</p>
          <p>应用的所有功能均使用豆瓣FM移动版API构建。</p>
          <p>Petal的诞生离不开<span onClick={openInDefaultBrowser('https://douban.fm')}>豆瓣FM</span>。</p>
          <p>不得将此应用用于任何非法用途。</p>
